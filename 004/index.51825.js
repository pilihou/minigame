System.register(["./application.0e4d7.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_application0e4d7Js) {
      createApplication = _application0e4d7Js.createApplication;
    }],
    execute: function () {
